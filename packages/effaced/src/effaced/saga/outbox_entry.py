...
class OutboxEntry(BaseModel):
    ...
    Attributes:
        ...
        attempts: How many times the call has been tried.
        enqueued_at: When the entry was committed (UTC).
        last_attempt_at: When the last try happened, if any (UTC).
        last_error: Short error note from the last failed try (no PII).
    """
