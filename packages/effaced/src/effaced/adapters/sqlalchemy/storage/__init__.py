...
Consent records, audit events and outbox entries live in the *user's*
database — zero data leaves their system in OSS mode. :func:`bind_tables`
defines the three ``effaced_``-prefixed tables on a caller-supplied
``MetaData`` so they flow through the application's own migrations
