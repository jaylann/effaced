---
title: The manifest
description: DataMap and the subject graph — the versioned picture of where personal data lives (derived or authored), with forward migrations and no rejected history.
---
...
the [annotations](../annotations/) they find, so it cannot drift from the
...
The authored path loads a hand-written or externally-generated payload with
