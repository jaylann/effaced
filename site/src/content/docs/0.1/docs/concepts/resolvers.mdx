---
title: Resolvers
description: The Resolver protocol reaches PII beyond your database — explicit
  registration, kind-based routing, and a strict idempotency contract.
slug: 0.1/docs/concepts/resolvers
---
