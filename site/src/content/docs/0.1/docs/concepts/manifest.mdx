---
title: The manifest
description: DataMap and the subject graph — the derived, versioned picture of
  where personal data lives, with forward migrations and no rejected history.
slug: 0.1/docs/concepts/manifest
---
