---
title: Quickstart
description: Annotate your models, wire the three calls, and run the saga runner
  — a working export/erasure/consent loop in minutes.
slug: 0.1/docs/quickstart
---
...
<Steps>
  1. **Install.** Not on PyPI yet — until 0.1.0 ships, install both
     packages straight from the repo:
